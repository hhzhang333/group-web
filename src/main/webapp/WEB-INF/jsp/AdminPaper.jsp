    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>云计算与大数据研究组 <small>论文管理</small></h5>
                            <div class="ibox-tools">
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#Add"><span class="glyphicon glyphicon-plus"></span>上传论文</button>
                            </div>
                        </div>
                            ...
                            <table id="dataTables" class="table table-striped table-bordered table-hover ">
                                ...
                                <c:if test="${!empty paperList}">
                                    <c:forEach var="paper" items="${paperList}">
                                        <tr>
                                            <td>${paper.id}</td>
                                            <td><fmt:formatDate pattern="yyyy-MM-dd"  value="${paper.pdate}" /></td>
                                            <td>${paper.title}</td>
                                            <td>${paper.author}</td>
                                            <td>${paper.pgroup}</td>
                                            <td>${paper.pname}</td>
                                            <td>
                                                <button  type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" onclick="deleteConfirm(${paper.id})">
        ...
        <div class="footer">
            <div class="pull-right">
                <a style='color:grey' href="../paper/admin"><span class="glyphicon glyphicon-arrow-up"></span>回到顶部</a>
            </div>
            <div>
            ...
            <form action="insert" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" placeholder="请输入文本" required="" name="title">
                        </div>
                    </div>
                    <div>&nbsp;</div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" placeholder="请输入文本" required="" name="author">
                        </div>
                    </div>
                    <div>&nbsp;</div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" placeholder="请输入文本" required="" name="book">
                        </div>
                    </div>
                    <div>&nbsp;</div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" placeholder="请输入文本" required="" name="page">
                        </div>
                    </div>
                    <div>&nbsp;</div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label">pdf资源：</label>
                        <div class="col-sm-9">
...
<script>
    ...
    {
        if (confirm('确实要删除此篇论文吗?'))
        {
            location.href="../paper/delete?adminPaperid="+deleteID;
